...
class TurnTableExtension extends Autodesk.Viewing.Extension {
    constructor(viewer, options) {
        ...
        this._button = null;
        this.requestId = null;
//        get rid of control points access by extensionloader from Autodesk example
//        this.customize = this.customize.bind(this);
    }

    load() {

        /*      get rid of control points accessed by getInstanceTree or OBJECT_TREE_CREATED_EVENT from Autodesk example
        ...
        */
        ...
        console.log('CameraRotation loaded.');
        return true;
    }
    ...
    unload() {
        ...
        console.log('CameraRotation is now unloaded!');
        return true;
    }
    ...
    onToolbarCreated() {
        ...
        nav.setPivotPoint(new THREE.Vector3(0, 0, 0));
        ...
        let rotateCamera = () => {
            ...
            // Translate the camera position relative to the new pivot
