...
class HistogramExtension extends BaseExtension {
    ...
    onToolbarCreated() {
        ...
        this._barChartButton = this.createToolbarButton('dashboard-barchart-button', './img/bar-chart.png', 'Show Property Histogram (Bar Chart)');
        ...
        this._pieChartButton = this.createToolbarButton('dashboard-piechart-button', './img/pie-chart.png', 'Show Property Histogram (Pie Chart)');
