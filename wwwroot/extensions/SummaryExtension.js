...
const SUMMARY_PROPS = ['Name','Length', 'Area', 'Volume', 'Density', 'Mass', 'Price'];
// const SUMMARY_PROPS = ['Type'];
...
class SummaryExtension extends BaseExtension {
    ...
    onToolbarCreated() {
        ...
        this._button = this.createToolbarButton('summary-button', './img/brief.png', 'Show Model Summary');
